            ...
            <div class="border-2 border-black">
                <div id="element-to-convert" >
                    ...
                    <div class="mx-10">
                        ...
                        <div class="text-secondary text-center">Nomor : nomor BAHP</div>
                        ...
                        <div class="mt-5 indent-10 text-justify" >Terlah melakukan pemeriksaa dan penelitian atas pekerjaan <span class="text-secondary">{{procurement.name}}</span> sebagaimana daftar terlampir yang diserahkan oleh {{procurement.suppliers.name}}. Hasil pemeriksaan dinyatakan bahwa pekerjaan tersebut telah dilaksanakan dengan baik serta sesuai dengan SPK nomor {{procurement.contract.no_spk}} tanggal <span class="text-secondary">{{getSimpleDate()}}</span>. </div>
