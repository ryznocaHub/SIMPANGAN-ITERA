                    ...
                    <Container  >
                        ...
                        buttons-pagination>
                            ...
                            <template #item-aksi="{ id }">
                                <Link @click="loading()" :href="route('ppk.procurement.show', id)" class="btn btn-xs text-first bg-slate-200 border-none hover:text-white hover:bg-first font-bold" >Lihat</Link>
                            </template>
                        </EasyDataTable>
                    </Container>
...
const label = ['Penunjukan Tim HPS', 'Pembuatan HPS', 'Persetujuan HPS', 'HPS ditolak', 'HPS diterima']
