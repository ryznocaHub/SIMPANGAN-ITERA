...
const emit = defineEmits(['files-dropped','verifikasi'])
...
function onDrop(e) {
	setInactive()
	console.log("drpzoneimg")
	emit('files-dropped', [...e.dataTransfer.files])
	// const cek = URL.createObjectURL(e.dataTransfer.files);
	// console.log(e.dataTransfer.files);
	emit('verifikasi', e.dataTransfer.files[0])
}
